...
| **`na_values`**                         | Set of values to be interpreted as _NULL_ when retrieving data from the input sources. The set of values must be separated by commas.                                                                                                        | **Default:** ",\,\n,\r                                                                                                                                                     |
| **`literal_escaping_chars`**                         | Set of characters to be escaped in the generation of literals. The set of characters must be separated by commas.                                                                                                        | **Default:** ,_nan_                                                                                                                                                     |
